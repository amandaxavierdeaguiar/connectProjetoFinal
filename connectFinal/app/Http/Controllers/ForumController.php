...
//         if (!$post) {
//             return redirect()->route('forum.list')->with('error', 'Post não encontrado.');
//         }

//         // Keep the existing photo unless a new one is uploaded
//         $foto = $post->foto;
...
//         // Store the new photo if it exists
//         if ($request->hasFile('foto')) {
//             $foto = Storage::putFile('uploadedPhotos', $request->foto);
//         }
...
//     // Redirect back to the forum list with a success message
//     return redirect()->route('forum.list')->with('message', 'Post ' . $action . ' com sucesso!');
// }
